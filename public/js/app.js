...
Vue.component('zonas', __webpack_require__(47));
Vue.component('personas', __webpack_require__(50));
...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['csrfToken'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
    ...
    methods: {
        ...
        getUser: function getUser(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(url).then(function (response) {
                ...
                _this2.user.correo = response.data.email;
                _this2.user.contraseña_anterior = response.data.password;
                _this2.user.rol = response.data.roles[0].name;
            });
        },
        getRoles: function getRoles() {
            var _this3 = this;
        ...
        updateUser: function updateUser() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(url, this.user).then(function (response) {
                ...
                if (response.data.mensaje = 'Usuario actualizado') {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_toastr___default.a.error(response.data.mensaje);
                }
            });
        },
        addUser: function addUser() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(url, this.newUser).then(function (response) {
        ...
        deleteUser: function deleteUser(id) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()({
                ...
                if (willDelete) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_2_sweetalert___default()("El usuario no fue eliminado");
                }
            });
        }
    }
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "row" }, [
    _c("div", { class: _vm.botonNuevoUsuario }, [_vm._m(0)]),
    _vm._v(" "),
    _c("div", { class: _vm.col }, [
      _c("table", { staticClass: "table table-hover table-bordered" }, [
        _c(
    ...
    _vm.isActive
      ? _c("div", { staticClass: "col-md-4" }, [
          _c("form", { attrs: { role: "form" } }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              _c("label", [_vm._v("Contraseña Anterior")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.user.contraseña_anterior,
                    expression: "user.contraseña_anterior"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "password" },
                domProps: { value: _vm.user.contraseña_anterior },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.user.contraseña_nueva,
                    expression: "user.contraseña_nueva"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "password" },
                domProps: { value: _vm.user.contraseña_nueva },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.user, "contraseña_nueva", $event.target.value)
                  }
                }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              _c("label", [_vm._v("Repetir Nueva Contraseña")]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.user.contraseña_repetida,
                    expression: "user.contraseña_repetida"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "password" },
                domProps: { value: _vm.user.contraseña_repetida },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
    ...
    _c(
      "div",
      { staticClass: "modal modal-default fade", attrs: { id: "modal-info" } },
      [
          ...
          _c("div", { staticClass: "modal-content" }, [
            ...
            _c("div", { staticClass: "modal-body" }, [
              _c("form", { staticClass: "form-horizontal" }, [
                _c("div", { staticClass: "box-body" }, [
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    _c("label", { staticClass: "col-sm-3 control-label" }, [
                      _vm._v("Confirmación Contraseña")
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "col-sm-9" }, [
                      _c("input", {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.newUser.rol,
                              expression: "newUser.rol"
                            }
                          ],
                          staticClass: "form-control",
                          on: {
            ...
            _c("div", { staticClass: "modal-footer" }, [
              _c(
                "button",
                {
                  staticClass: "btn btn-default btn-flat pull-left",
...
var staticRenderFns = [
      ...
      [
        _c(
          "a",
          {
            ...
            attrs: { "data-toggle": "modal", "data-target": "#modal-info" }
          },
          [_c("span", { staticClass: "fa fa-plus" }), _vm._v(" Nuevo Usuario")]
        )
      ]
    )
  },
  function() {
    ...
    return _c("tr", [
      ...
      _vm._v(" "),
      _c("th", { attrs: { width: "35%" } }, [_vm._v("Email")]),
      _vm._v(" "),
      _c("th", { attrs: { width: "20%" } }, [_vm._v("Acciones")])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      ...
      _c("h4", { staticClass: "modal-title" }, [
        _vm._v("Formulario de registro de usuarios")
      ])
    ])
  }
]
...
Component.options.__file = "resources\\assets\\js\\components\\Zona.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0c59fd9f", Component.options)
  } else {
    hotAPI.reload("data-v-0c59fd9f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      _c(
        ...
        [
          ...
          _c("rect", {
            ...
            attrs: { x: "0.5", y: "0.73", width: "69", height: "60" },
            on: { click: _vm.asd },
            model: {
              value: _vm.permiso1,
              callback: function($$v) {
          ...
          _vm._v(" "),
          _c("text", { attrs: { x: "30", y: "35", fill: "blue" } }, [
            _vm._v("1")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "69.5", y: "0.73", width: "70", height: "60" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "100", y: "35", fill: "blue" } }, [
            _vm._v("2")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "139.5", y: "0.73", width: "69", height: "60" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "170", y: "35", fill: "blue" } }, [
            _vm._v("3")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "208.5", y: "0.73", width: "72", height: "60" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "240", y: "35", fill: "blue" } }, [
            _vm._v("4")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "280.5", y: "0.73", width: "87", height: "129" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "320", y: "70", fill: "blue" } }, [
            _vm._v("5")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "367.5", y: "0.73", width: "82", height: "129" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "405", y: "70", fill: "blue" } }, [
            _vm._v("6")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "449.5", y: "0.73", width: "62", height: "129" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "475", y: "70", fill: "blue" } }, [
            _vm._v("7")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "511.5", y: "0.73", width: "63", height: "129" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "540", y: "70", fill: "blue" } }, [
            _vm._v("8")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "0.5", y: "60.73", width: "69", height: "58" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "30", y: "95", fill: "blue" } }, [
            _vm._v("9")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "0.5", y: "118.73", width: "69", height: "99" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "30", y: "170", fill: "blue" } }, [
            _vm._v("10")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "95.5", y: "80.73", width: "157", height: "130" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "170", y: "150", fill: "blue" } }, [
            _vm._v("11")
          ]),
          _vm._v(" "),
          _c("polygon", {
            ...
            attrs: {
              points:
                "574.5 0.73 574.5 319.73 724.5 319.73 724.5 542.73 801.5 542.73 801.5 87.73 574.5 0.73"
            }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "680", y: "200", fill: "blue" } }, [
            _vm._v("12")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "120.5", y: "266.73", width: "160", height: "62" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "195", y: "300", fill: "blue" } }, [
            _vm._v("13")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "367.5", y: "242.73", width: "61", height: "80" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "395", y: "290", fill: "blue" } }, [
            _vm._v("14")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "367.5", y: "322.73", width: "61", height: "95" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "395", y: "375", fill: "blue" } }, [
            _vm._v("15")
          ]),
          _vm._v(" "),
          _c("rect", {
            class: _vm.classActive,
            attrs: { x: "367.5", y: "417.73", width: "61", height: "76" }
          }),
          _vm._v(" "),
          _c("text", { attrs: { x: "395", y: "460", fill: "blue" } }, [
            _vm._v("16")
          ]),
          _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0c59fd9f", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Personal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3585a692", Component.options)
  } else {
    hotAPI.reload("data-v-3585a692", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
        ...
        _vm._l(_vm.personas, function(persona) {
          return [
            _c("tr", [
              ...
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(persona.apellido))]),
              _vm._v(" "),
              _vm._m(1, true)
            ])
          ]
...
var staticRenderFns = [
  function() {
    ...
    return _c("tr", [
      ...
      _c("th", { attrs: { width: "35%" } }, [_vm._v("Nombre")]),
      _vm._v(" "),
      _c("th", { attrs: { width: "35%" } }, [_vm._v("Apellido")]),
      _vm._v(" "),
      _c("th", { attrs: { width: "20%" } }, [_vm._v("Acciones")])
    ])
  },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3585a692", module.exports)
  }
}
